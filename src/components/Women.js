...
const Women = () => {
    const [womenSneakers, setSneakers] = useState([]);
    useEffect(() => {
        async function getSneakers() {
            const rsp = await fetch('https://v1-sneakers.p.rapidapi.com/v1/sneakers?limit=15&gender=women', {
                "method": "GET",
                "headers": {
